...
class Kategori_download extends CI_Controller
{
	...
	public function index()
	{
		...
		$valid->set_rules(
			...
			'Nama kategori_download',
			'required|is_unique[kategori_download.nama_kategori_download]',
			array(
				'required'		=> 'Nama kategori_download harus diisi',
